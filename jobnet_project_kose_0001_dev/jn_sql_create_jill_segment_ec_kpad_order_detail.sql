...
--jn_job_jill_segment_0002 より、 「jill_segment_ec_kpad_order」を変更したもの。
SELECT
    A.order_code
  , A.order_detail_code
  , A.sku_code
...
FROM kosedmp_prd_secure.order_detail as A
  ...
  LEFT JOIN kosedmp_prd_secure.jill_segment_ec_kpad_order as C
...
--以下条件は jill_common_segment_0004 で排除済み
-- AND C.shipped_timestamp <> '' 
