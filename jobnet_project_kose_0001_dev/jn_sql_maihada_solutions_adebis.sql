...
( SELECT adid,mediaid,adgroup1id,adgroup2id 
  FROM kosedmp_prd_secure.adebis_ads ads 
  GROUP BY adid,mediaid,adgroup1id,adgroup2id
) ads
JOIN kosedmp_prd_secure.adebis_medias medias
 ON ads.mediaid = medias.mediaid
JOIN kosedmp_prd_secure.adebis_adgroup1s gp1
 ON ads.adgroup1id = gp1.adgroupid
JOIN kosedmp_prd_secure.adebis_adgroup2s gp2
