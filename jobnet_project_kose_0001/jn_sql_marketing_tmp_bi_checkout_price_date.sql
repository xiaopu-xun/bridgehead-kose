SELECT
	...
	(CASE WHEN x1.td_system_code = 'B' THEN 'K-PAD'
	WHEN x1.td_system_code = 'C' THEN 'Awake'
	WHEN x1.td_system_code = 'D' THEN 'フローラノーティス'
	WHEN x1.td_system_code = 'E' THEN 'ジルスチュアート'
	WHEN x1.td_system_code = 'G' THEN 'アディクション'
	WHEN x1.td_system_code = 'J' THEN '米肌'
	WHEN x1.td_system_code = 'L' THEN 'DECORTE'
